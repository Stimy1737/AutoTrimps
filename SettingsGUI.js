...
//AutoMaps + VoidMaps settings:
    ...
    createSetting('RunVoidsBeforePortal','Run Voids Before Portal','Will run all voids before portaling in U2','boolean',false,null,'Maps');
